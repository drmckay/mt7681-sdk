...
main (VOID)
{
	...
	IoT_gpio_output(4, 0);//set gpio4 as low level at the beginning,GPIO4 is the relay control pin on xWifi base board
	IoT_gpio_output(0, 1);//set gpio0 as high level at the beginning,GPIO0 is the Humidity&Temperature sensor communication pin on xWifi base board 
#endif
