...
typedef enum t_FunctionCommand
{
	...
	HUM_TEMP_GET_REQUEST,//Temperature-Humidity sensor 
	HUM_TEMP_GET_RESPONSE,//Temperature-Humidity sensor  
#endif
...
typedef enum t_DataType
{
	...
	CONTROL_PASSWORD,
#if (XWIFI_BOARD_SUPPORT==1) 
	HUM_TEMP_INFORMATION//Temperature-Humidity sensor 
#endif
}DataType;
...
#if (XWIFI_BOARD_SUPPORT==1)
typedef struct GNU_PACKED t_HUM_TEMP_Information
{
	UINT_16 HUM_Value;
	UINT_16 TEMP_Value;
}HUM_TEMP_Information;//Temperature-Humidity sensor 
